    ...
    return (
        <div className='p-4'>
            <div data-aos="fade-up" >
                ...
                <p className='text-center md:text-3xl font-semibold relative md:-top-14 underline decoration-[#08d665]'>My Skills</p>
            </div>


            <div data-aos="fade-up" className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {/* Skill Card 1 */}
          <div data-aos="zoom-in-up" className=" p-6 rounded-lg  hover:text-[#08d665] border-b-4 border-[#08d665]">
          ...
          <div data-aos="zoom-in-up" className="  p-6 rounded-lg   hover:text-[#08d665] border-b-4 border-[#08d665]">
            ...
            <img className='w-11 mb-3' src={css} alt=""  />
            <div className="flex items-center">
              <div className="flex-1">
           ...
           <div data-aos="zoom-in-up" className="  p-6 rounded-lg   hover:text-[#08d665] border-b-4 border-[#08d665]">
            ...
            <img className='w-14 mb-3' src={mongodb} alt="" />
            <div className="flex items-center">
              <div className="flex-1">
                <div className="progress-bar bg-white w-2/3 h-4 rounded-full">
        ...
        <div data-aos="zoom-in-up" className=" p-6 rounded-lg   hover:text-[#08d665] border-b-4 border-[#08d665]">
          ...
          <img className='w-14 mb-3' src={bots} alt="Bootstrap" />
          <div className="flex items-center">
            <div className="flex-1">
              <div className="progress-bar bg-white w-2/3 h-4 rounded-full">
                <div className="progress-bar-inner bg-purple-400 h-full rounded-full"></div>
